...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $sth = $dbh->prepare('INSERT INTO tbl_doctor VALUES(NULL,?,?,?,?,?,?)');
        ...
        $sth->bindValue(5, $user->job, PDO::PARAM_STR);
        $sth->bindValue(6, $user->gender, PDO::PARAM_STR);
    ...
    try {
        ...
        $sth = $dbh->prepare('SELECT * FROM tbl_doctor');
